...
export class Backend implements backendInterface {
    ...
    async addLoveQuote(arg0: LoveQuote): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addLoveQuote(to_candid_LoveQuote_n8(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addPhotoEntry(arg0: PhotoEntry): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addPhotoEntry(await to_candid_PhotoEntry_n10(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addShayari(arg0: Shayari): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addShayari(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteLoveQuote(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteLoveQuote(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deletePhotoEntry(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deletePhotoEntry(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteShayari(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteShayari(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async editLoveQuote(arg0: LoveQuote): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.editLoveQuote(to_candid_LoveQuote_n8(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async editPhotoEntry(arg0: PhotoEntry): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.editPhotoEntry(await to_candid_PhotoEntry_n10(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async editShayari(arg0: Shayari): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.editShayari(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllPhotoEntries(): Promise<Array<PhotoEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllPhotoEntries();
    ...
    async getAllShayari(): Promise<Array<Shayari>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllShayari();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getLoveQuoteById(arg0: string): Promise<LoveQuote | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getLoveQuoteById(arg0);
    ...
    async getPhotoEntryById(arg0: string): Promise<PhotoEntry | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getPhotoEntryById(arg0);
    ...
    async getShayariById(arg0: string): Promise<Shayari | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getShayariById(arg0);
...
function from_candid_LoveQuote_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _LoveQuote): LoveQuote {
    return from_candid_record_n17(_uploadFile, _downloadFile, value);
}
async function from_candid_PhotoEntry_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PhotoEntry): Promise<PhotoEntry> {
...
function from_candid_opt_n26(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_LoveQuote]): LoveQuote | null {
    return value.length === 0 ? null : from_candid_LoveQuote_n16(_uploadFile, _downloadFile, value[0]);
}
async function from_candid_opt_n27(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_PhotoEntry]): Promise<PhotoEntry | null> {
    return value.length === 0 ? null : await from_candid_PhotoEntry_n20(_uploadFile, _downloadFile, value[0]);
}
function from_candid_opt_n28(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Shayari]): Shayari | null {
    return value.length === 0 ? null : value[0];
}
...
function from_candid_vec_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_LoveQuote>): Array<LoveQuote> {
    return value.map((x)=>from_candid_LoveQuote_n16(_uploadFile, _downloadFile, x));
}
async function from_candid_vec_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_PhotoEntry>): Promise<Array<PhotoEntry>> {
    return await Promise.all(value.map(async (x)=>await from_candid_PhotoEntry_n20(_uploadFile, _downloadFile, x)));
}
...
function to_candid_LoveQuote_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: LoveQuote): _LoveQuote {
    return to_candid_record_n9(_uploadFile, _downloadFile, value);
}
async function to_candid_PhotoEntry_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: PhotoEntry): Promise<_PhotoEntry> {
